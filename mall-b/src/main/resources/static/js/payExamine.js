...
layui.use(['laydate', 'laypage', 'layer', 'table', 'carousel', 'upload', 'element', 'slider'], function(){
    ...
    table.render({
        ...
        ,cols: [[ //表头
            ...
            ,{field: 'payId', title: '支付ID', width: 274, sort: true}
            ...
            ,{field: 'payState', title: '订单状态', width: 105, sort: true}
            ,{field: 'voucherState', title: '付款凭证状态', width: 200, sort: true}
    ...
    table.on('row(test)',function (res) {
        var index = layer.open({
            type: 2,
            content: '/admin/pay/layer/examine',
            area: ['500px', '800px'],
            maxmin: true,
